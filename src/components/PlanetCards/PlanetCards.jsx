...
const PlanetCards = ({ planets, count, currentPage, setCurrentPage }) => {
    ...
    return (
        <div className={style.cardsContainer}>
            <Container>
                ...
                <Row> <Paginator_Container currentPage={currentPage} setCurrentPage={setCurrentPage} count={count} /> </Row>
